...
class BodegasController {
  ...
  static async create(req, res, next) {
    try {
      const data = await BodegasService.create(req.body, req.user?.id);
  ...
  static async update(req, res, next) {
    try {
      const data = await BodegasService.update(req.params.id, req.body, req.user?.id);
  ...
  static async remove(req, res, next) {
    try {
      const data = await BodegasService.remove(req.params.id, req.user?.id);
